...
// @description **OpenAPI:** served at `/swagger/doc.json` as **OpenAPI 3.0.3** when `HTTP_SWAGGER_UI_ENABLED=true`. Swagger UI exposes a **Servers** dropdown with **Production** first (default: `https://api.ldtv.dev`), then **Development** (`http://localhost:8080`); regenerate with `make swagger` or `tools/build_openapi.py` when hosts change.
