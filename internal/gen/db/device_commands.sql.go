...
func (q *Queries) AdminOpsGetCommandLedgerForOrg(ctx context.Context, id uuid.UUID) (CommandLedger, error) {
	row := q.db.QueryRow(ctx, AdminOpsGetCommandLedgerForOrg, id)
	var i CommandLedger
	err := row.Scan(
		&i.ID,
		&i.MachineID,
...
func (q *Queries) UpdateCommandLedgerMQTTDispatchMeta(ctx context.Context, arg UpdateCommandLedgerMQTTDispatchMetaParams) error {
	_, err := q.db.Exec(ctx, UpdateCommandLedgerMQTTDispatchMeta, arg.TimeoutAt, arg.Column2, arg.ID)
	return err
}
...
func (q *Queries) UpdateMachineCommandAttemptAfterDeviceReceipt(ctx context.Context, arg UpdateMachineCommandAttemptAfterDeviceReceiptParams) error {
	_, err := q.db.Exec(ctx, UpdateMachineCommandAttemptAfterDeviceReceipt, arg.Status, arg.ID)
	return err
}
...
func (q *Queries) UpdateMachineCommandAttemptPublishFailed(ctx context.Context, arg UpdateMachineCommandAttemptPublishFailedParams) error {
	_, err := q.db.Exec(ctx, UpdateMachineCommandAttemptPublishFailed, arg.TimeoutReason, arg.ID)
	return err
}
...
func (q *Queries) UpdateMachineCommandAttemptSent(ctx context.Context, arg UpdateMachineCommandAttemptSentParams) error {
	_, err := q.db.Exec(ctx, UpdateMachineCommandAttemptSent, arg.AckDeadlineAt, arg.ID)
	return err
}
