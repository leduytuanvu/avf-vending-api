...
// versions:
//   sqlc v1.29.0
// source: operational_anomalies.sql
...
const AdminOpsIgnoreInventoryAnomaly = `-- name: AdminOpsIgnoreInventoryAnomaly :one
...
type AdminOpsIgnoreInventoryAnomalyParams struct {
	ID             uuid.UUID
...
func (q *Queries) AdminOpsIgnoreInventoryAnomaly(ctx context.Context, arg AdminOpsIgnoreInventoryAnomalyParams) (uuid.UUID, error) {
	row := q.db.QueryRow(ctx, AdminOpsIgnoreInventoryAnomaly,
		arg.ID,
		arg.OrganizationID,
		arg.ResolvedBy,
		arg.ResolutionNote,
...
const AnomaliesGetByOrgAndID = `-- name: AnomaliesGetByOrgAndID :one
SELECT
    ia.id,
    ia.organization_id,
    ia.machine_id,
...
type AnomaliesGetByOrgAndIDParams struct {
	OrganizationID uuid.UUID
	AnomalyID      uuid.UUID
}

type AnomaliesGetByOrgAndIDRow struct {
	ID                  uuid.UUID
	OrganizationID      uuid.UUID
	MachineID           uuid.UUID
	AnomalyType         string
...
func (q *Queries) AnomaliesGetByOrgAndID(ctx context.Context, arg AnomaliesGetByOrgAndIDParams) (AnomaliesGetByOrgAndIDRow, error) {
	row := q.db.QueryRow(ctx, AnomaliesGetByOrgAndID, arg.OrganizationID, arg.AnomalyID)
	var i AnomaliesGetByOrgAndIDRow
	err := row.Scan(
		&i.ID,
		&i.OrganizationID,
		&i.MachineID,
...
const AnomaliesInsertCommandFailureSpike = `-- name: AnomaliesInsertCommandFailureSpike :execrows
...
func (q *Queries) AnomaliesInsertCommandFailureSpike(ctx context.Context, organizationID uuid.UUID) (int64, error) {
	result, err := q.db.Exec(ctx, AnomaliesInsertCommandFailureSpike, organizationID)
	if err != nil {
		return 0, err
	}
...
const AnomaliesInsertHighCashVariance = `-- name: AnomaliesInsertHighCashVariance :execrows
INSERT INTO inventory_anomalies (
    organization_id,
    machine_id,
    anomaly_type,
...
func (q *Queries) AnomaliesInsertHighCashVariance(ctx context.Context, organizationID uuid.UUID) (int64, error) {
	result, err := q.db.Exec(ctx, AnomaliesInsertHighCashVariance, organizationID)
	if err != nil {
		return 0, err
	}
	return result.RowsAffected(), nil
...
const AnomaliesInsertLowStockThreshold = `-- name: AnomaliesInsertLowStockThreshold :execrows
INSERT INTO inventory_anomalies (
    organization_id,
    machine_id,
    anomaly_type,
...
func (q *Queries) AnomaliesInsertLowStockThreshold(ctx context.Context, organizationID uuid.UUID) (int64, error) {
	result, err := q.db.Exec(ctx, AnomaliesInsertLowStockThreshold, organizationID)
	if err != nil {
		return 0, err
	}
	return result.RowsAffected(), nil
...
const AnomaliesInsertMachineOfflineTooLong = `-- name: AnomaliesInsertMachineOfflineTooLong :execrows
INSERT INTO inventory_anomalies (
    organization_id,
    machine_id,
    anomaly_type,
...
func (q *Queries) AnomaliesInsertMachineOfflineTooLong(ctx context.Context, organizationID uuid.UUID) (int64, error) {
	result, err := q.db.Exec(ctx, AnomaliesInsertMachineOfflineTooLong, organizationID)
	if err != nil {
		return 0, err
	}
	return result.RowsAffected(), nil
...
const AnomaliesInsertNegativeStockAttempt = `-- name: AnomaliesInsertNegativeStockAttempt :execrows
INSERT INTO inventory_anomalies (
    organization_id,
    machine_id,
    anomaly_type,
...
func (q *Queries) AnomaliesInsertNegativeStockAttempt(ctx context.Context, organizationID uuid.UUID) (int64, error) {
	result, err := q.db.Exec(ctx, AnomaliesInsertNegativeStockAttempt, organizationID)
	if err != nil {
		return 0, err
	}
	return result.RowsAffected(), nil
...
const AnomaliesInsertRepeatedPaymentFailure = `-- name: AnomaliesInsertRepeatedPaymentFailure :execrows
INSERT INTO inventory_anomalies (
    organization_id,
    machine_id,
    anomaly_type,
...
func (q *Queries) AnomaliesInsertRepeatedPaymentFailure(ctx context.Context, organizationID uuid.UUID) (int64, error) {
	result, err := q.db.Exec(ctx, AnomaliesInsertRepeatedPaymentFailure, organizationID)
	if err != nil {
		return 0, err
	}
	return result.RowsAffected(), nil
...
const AnomaliesInsertRepeatedVendFailure = `-- name: AnomaliesInsertRepeatedVendFailure :execrows
INSERT INTO inventory_anomalies (
    organization_id,
    machine_id,
    anomaly_type,
...
func (q *Queries) AnomaliesInsertRepeatedVendFailure(ctx context.Context, organizationID uuid.UUID) (int64, error) {
	result, err := q.db.Exec(ctx, AnomaliesInsertRepeatedVendFailure, organizationID)
	if err != nil {
		return 0, err
	}
	return result.RowsAffected(), nil
...
const AnomaliesInsertSoldOutSoonEstimate = `-- name: AnomaliesInsertSoldOutSoonEstimate :execrows
INSERT INTO inventory_anomalies (
    organization_id,
    machine_id,
    anomaly_type,
...
func (q *Queries) AnomaliesInsertSoldOutSoonEstimate(ctx context.Context, organizationID uuid.UUID) (int64, error) {
	result, err := q.db.Exec(ctx, AnomaliesInsertSoldOutSoonEstimate, organizationID)
	if err != nil {
		return 0, err
	}
	return result.RowsAffected(), nil
...
const AnomaliesInsertStockMismatch = `-- name: AnomaliesInsertStockMismatch :execrows
INSERT INTO inventory_anomalies (
    organization_id,
    machine_id,
    anomaly_type,
...
func (q *Queries) AnomaliesInsertStockMismatch(ctx context.Context, organizationID uuid.UUID) (int64, error) {
	result, err := q.db.Exec(ctx, AnomaliesInsertStockMismatch, organizationID)
	if err != nil {
		return 0, err
	}
	return result.RowsAffected(), nil
...
const AnomaliesInsertTelemetryMissing = `-- name: AnomaliesInsertTelemetryMissing :execrows
INSERT INTO inventory_anomalies (
    organization_id,
    machine_id,
    anomaly_type,
...
func (q *Queries) AnomaliesInsertTelemetryMissing(ctx context.Context, organizationID uuid.UUID) (int64, error) {
	result, err := q.db.Exec(ctx, AnomaliesInsertTelemetryMissing, organizationID)
	if err != nil {
		return 0, err
	}
	return result.RowsAffected(), nil
