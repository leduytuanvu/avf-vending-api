...
func (q *Queries) AdminOpsIgnoreInventoryAnomaly(ctx context.Context, arg AdminOpsIgnoreInventoryAnomalyParams) (uuid.UUID, error) {
	row := q.db.QueryRow(ctx, AdminOpsIgnoreInventoryAnomaly, arg.ResolvedBy, arg.ResolutionNote, arg.ID)
	var id uuid.UUID
	err := row.Scan(&id)
	return id, err
}
...
func (q *Queries) AnomaliesGetByOrgAndID(ctx context.Context, anomalyID uuid.UUID) (AnomaliesGetByOrgAndIDRow, error) {
	row := q.db.QueryRow(ctx, AnomaliesGetByOrgAndID, anomalyID)
...
func (q *Queries) AnomaliesInsertCommandFailureSpike(ctx context.Context) (int64, error) {
	result, err := q.db.Exec(ctx, AnomaliesInsertCommandFailureSpike)
	if err != nil {
		return 0, err
	}
...
func (q *Queries) AnomaliesInsertHighCashVariance(ctx context.Context) (int64, error) {
	result, err := q.db.Exec(ctx, AnomaliesInsertHighCashVariance)
	if err != nil {
		return 0, err
	}
	return result.RowsAffected(), nil
...
func (q *Queries) AnomaliesInsertLowStockThreshold(ctx context.Context) (int64, error) {
	result, err := q.db.Exec(ctx, AnomaliesInsertLowStockThreshold)
	if err != nil {
		return 0, err
	}
	return result.RowsAffected(), nil
...
func (q *Queries) AnomaliesInsertMachineOfflineTooLong(ctx context.Context) (int64, error) {
	result, err := q.db.Exec(ctx, AnomaliesInsertMachineOfflineTooLong)
	if err != nil {
		return 0, err
	}
	return result.RowsAffected(), nil
...
func (q *Queries) AnomaliesInsertNegativeStockAttempt(ctx context.Context) (int64, error) {
	result, err := q.db.Exec(ctx, AnomaliesInsertNegativeStockAttempt)
	if err != nil {
		return 0, err
	}
	return result.RowsAffected(), nil
...
func (q *Queries) AnomaliesInsertRepeatedPaymentFailure(ctx context.Context) (int64, error) {
	result, err := q.db.Exec(ctx, AnomaliesInsertRepeatedPaymentFailure)
	if err != nil {
		return 0, err
	}
	return result.RowsAffected(), nil
...
func (q *Queries) AnomaliesInsertRepeatedVendFailure(ctx context.Context) (int64, error) {
	result, err := q.db.Exec(ctx, AnomaliesInsertRepeatedVendFailure)
	if err != nil {
		return 0, err
	}
	return result.RowsAffected(), nil
...
func (q *Queries) AnomaliesInsertSoldOutSoonEstimate(ctx context.Context) (int64, error) {
	result, err := q.db.Exec(ctx, AnomaliesInsertSoldOutSoonEstimate)
	if err != nil {
		return 0, err
	}
	return result.RowsAffected(), nil
...
func (q *Queries) AnomaliesInsertStockMismatch(ctx context.Context) (int64, error) {
	result, err := q.db.Exec(ctx, AnomaliesInsertStockMismatch)
	if err != nil {
		return 0, err
	}
	return result.RowsAffected(), nil
...
func (q *Queries) AnomaliesInsertTelemetryMissing(ctx context.Context) (int64, error) {
	result, err := q.db.Exec(ctx, AnomaliesInsertTelemetryMissing)
	if err != nil {
		return 0, err
	}
	return result.RowsAffected(), nil
