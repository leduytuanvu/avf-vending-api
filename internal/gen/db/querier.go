...
type Querier interface {
	...
	CommerceAdminGetRefundRequestByScopeIdempotency(ctx context.Context, idempotencyKey pgtype.Text) (RefundRequest, error)
	...
	CommerceAdminOrderScopeID(ctx context.Context, id uuid.UUID) (CommerceAdminOrderScopeIDRow, error)
	...
	CountMachineActivationCodesForScope(ctx context.Context) (int64, error)
	...
	GetOrderByScopeIdempotency(ctx context.Context, idempotencyKey pgtype.Text) (Order, error)
	...
	ListMachineActivationCodesForScope(ctx context.Context, arg ListMachineActivationCodesForScopeParams) ([]MachineActivationCode, error)
	...
	ListMachinesByScopeID(ctx context.Context) ([]Machine, error)
	...
	PromotionAdminDeletePromotionTarget(ctx context.Context) (int64, error)
	PromotionAdminDeleteRulesForPromotion(ctx context.Context, promotionID uuid.UUID) error
	PromotionAdminGetProductCategory(ctx context.Context) (pgtype.UUID, error)
	PromotionAdminGetPromotion(ctx context.Context) (Promotion, error)
	PromotionAdminGetPromotionTarget(ctx context.Context) (PromotionTarget, error)
	...
	PromotionAdminListProductTagIDs(ctx context.Context) ([]uuid.UUID, error)
	...
	PromotionAdminListTargetsForPromotion(ctx context.Context) ([]PromotionTarget, error)
	PromotionAdminSetLifecycle(ctx context.Context, lifecycleStatus string) (Promotion, error)
	...
	RevokeMachineActivationCodeForScope(ctx context.Context, id uuid.UUID) (MachineActivationCode, error)
