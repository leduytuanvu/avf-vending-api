...
type Querier interface {
	...
	ClaimWinningPayment(ctx context.Context, arg ClaimWinningPaymentParams) (Order, error)
	CloseCashCollection(ctx context.Context, arg CloseCashCollectionParams) (CashCollection, error)
	CloseCurrentMachineLayoutAssignment(ctx context.Context, arg CloseCurrentMachineLayoutAssignmentParams) error
	...
	FleetAdminGetMachineSlotLayoutByKey(ctx context.Context, arg FleetAdminGetMachineSlotLayoutByKeyParams) (FleetAdminGetMachineSlotLayoutByKeyRow, error)
	...
	FleetAdminUpsertMachineSlotLayout(ctx context.Context, arg FleetAdminUpsertMachineSlotLayoutParams) (FleetAdminUpsertMachineSlotLayoutRow, error)
	ForceUpdatePaymentStateCaptured(ctx context.Context, id uuid.UUID) (Payment, error)
	...
	GetCashAcceptanceEventByID(ctx context.Context, id uuid.UUID) (CashAcceptanceEvent, error)
	GetCashAllocationForOrder(ctx context.Context, orderID uuid.UUID) (CashAllocation, error)
	GetCashChangeEventForOrder(ctx context.Context, orderID uuid.UUID) (CashChangeEvent, error)
	GetCashCollectionByIDForOrgMachine(ctx context.Context, arg GetCashCollectionByIDForOrgMachineParams) (CashCollection, error)
	GetCashPayoutEventByID(ctx context.Context, id uuid.UUID) (CashPayoutEvent, error)
	...
	GetCurrentMachineLayoutAssignment(ctx context.Context, arg GetCurrentMachineLayoutAssignmentParams) (MachineLayoutAssignment, error)
	...
	GetLatestCashHardwareObservation(ctx context.Context, arg GetLatestCashHardwareObservationParams) (CashHardwareObservation, error)
	...
	GetOrderWinningPaymentID(ctx context.Context, id uuid.UUID) (pgtype.UUID, error)
	...
	GetWinningPaymentForOrder(ctx context.Context, id uuid.UUID) (Payment, error)
	...
	InsertCashAcceptanceEvent(ctx context.Context, arg InsertCashAcceptanceEventParams) (CashAcceptanceEvent, error)
	InsertCashAdjustment(ctx context.Context, arg InsertCashAdjustmentParams) (CashAdjustment, error)
	InsertCashAllocation(ctx context.Context, arg InsertCashAllocationParams) (CashAllocation, error)
	InsertCashBillLifecycleEvent(ctx context.Context, arg InsertCashBillLifecycleEventParams) (CashBillLifecycleEvent, error)
	InsertCashChangeEvent(ctx context.Context, arg InsertCashChangeEventParams) (CashChangeEvent, error)
	InsertCashCollection(ctx context.Context, arg InsertCashCollectionParams) (CashCollection, error)
	InsertCashHardwareObservation(ctx context.Context, arg InsertCashHardwareObservationParams) (CashHardwareObservation, error)
	// Cash forensic ledger: ingest and read model queries.
	InsertCashPayoutEvent(ctx context.Context, arg InsertCashPayoutEventParams) (CashPayoutEvent, error)
	...
	ListCapturedPaymentsWithoutWinner(ctx context.Context, arg ListCapturedPaymentsWithoutWinnerParams) ([]Payment, error)
	ListCashAcceptanceEventsForMachineSince(ctx context.Context, arg ListCashAcceptanceEventsForMachineSinceParams) ([]CashAcceptanceEvent, error)
	ListCashAcceptanceEventsForOrder(ctx context.Context, orderID pgtype.UUID) ([]CashAcceptanceEvent, error)
	ListCashBillLifecycleEventsForLedger(ctx context.Context, arg ListCashBillLifecycleEventsForLedgerParams) ([]ListCashBillLifecycleEventsForLedgerRow, error)
	ListCashBillLifecycleEventsForOrder(ctx context.Context, orderID pgtype.UUID) ([]CashBillLifecycleEvent, error)
	ListCashCollectionsForMachine(ctx context.Context, arg ListCashCollectionsForMachineParams) ([]CashCollection, error)
	ListCashHardwareObservationsForLedger(ctx context.Context, arg ListCashHardwareObservationsForLedgerParams) ([]ListCashHardwareObservationsForLedgerRow, error)
	ListCashLedgerAcceptanceEvents(ctx context.Context, arg ListCashLedgerAcceptanceEventsParams) ([]ListCashLedgerAcceptanceEventsRow, error)
	ListCashLedgerPayoutEvents(ctx context.Context, arg ListCashLedgerPayoutEventsParams) ([]ListCashLedgerPayoutEventsRow, error)
	ListCashPayoutEventsForMachineSince(ctx context.Context, arg ListCashPayoutEventsForMachineSinceParams) ([]CashPayoutEvent, error)
	ListCashPayoutEventsForOrder(ctx context.Context, orderID pgtype.UUID) ([]CashPayoutEvent, error)
	...
	ListPaymentsForOrder(ctx context.Context, orderID uuid.UUID) ([]Payment, error)
	...
	ListUnresolvedCashPayoutAmbiguous(ctx context.Context, arg ListUnresolvedCashPayoutAmbiguousParams) ([]CashPayoutEvent, error)
	ListUnresolvedChangeLiability(ctx context.Context, arg ListUnresolvedChangeLiabilityParams) ([]CashChangeEvent, error)
	...
	PlanogramGetVersionByIDForMachine(ctx context.Context, arg PlanogramGetVersionByIDForMachineParams) (PlanogramGetVersionByIDForMachineRow, error)
	...
	PlanogramInsertVersion(ctx context.Context, arg PlanogramInsertVersionParams) (PlanogramInsertVersionRow, error)
	...
	PlanogramListVersionsForMachine(ctx context.Context, machineID uuid.UUID) ([]PlanogramListVersionsForMachineRow, error)
	...
	SumCashAcceptanceByMachineSince(ctx context.Context, arg SumCashAcceptanceByMachineSinceParams) (SumCashAcceptanceByMachineSinceRow, error)
	SumCashAdjustmentsByMachineSince(ctx context.Context, arg SumCashAdjustmentsByMachineSinceParams) (SumCashAdjustmentsByMachineSinceRow, error)
	SumCashPayoutConfirmedByMachineSince(ctx context.Context, arg SumCashPayoutConfirmedByMachineSinceParams) (int64, error)
	SumCollectedCashByMachineSince(ctx context.Context, arg SumCollectedCashByMachineSinceParams) (int64, error)
	...
	TopologyListSlotLayoutsForMachine(ctx context.Context, machineID uuid.UUID) ([]TopologyListSlotLayoutsForMachineRow, error)
	...
	UpdateCashAcceptanceEventOrder(ctx context.Context, arg UpdateCashAcceptanceEventOrderParams) error
	...
	UpdateMachineSlotLayoutGridDimensions(ctx context.Context, arg UpdateMachineSlotLayoutGridDimensionsParams) error
	UpdateOrderStatusByOrg(ctx context.Context, arg UpdateOrderStatusByOrgParams) (Order, error)
	UpdatePaymentOutcome(ctx context.Context, arg UpdatePaymentOutcomeParams) (Payment, error)
