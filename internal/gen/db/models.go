...
// Single-company feature switches; targets refine scope (site/machine/profile/canary).
...
// Immutable day/timezone (optional site/machine scope) snapshot; corrections via finance_daily_close_adjustments.
...
type MachineReconciliationSession struct {
	ID        uuid.UUID
	MachineID uuid.UUID
	// Operator calendar day in system timezone; store date only - resolve timezone in application.
