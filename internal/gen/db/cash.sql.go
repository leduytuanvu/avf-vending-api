...
func (q *Queries) CashSettlementLastClosedAt(ctx context.Context, machineID uuid.UUID) (time.Time, error) {
	row := q.db.QueryRow(ctx, CashSettlementLastClosedAt, machineID)
...
func (q *Queries) CashSettlementNetExpectedMinor(ctx context.Context, arg CashSettlementNetExpectedMinorParams) (int64, error) {
	row := q.db.QueryRow(ctx, CashSettlementNetExpectedMinor, arg.MachineID, arg.Currency)
	var net_minor int64
...
func (q *Queries) FindCashCollectionOpenByStartIdempotencyKey(ctx context.Context, arg FindCashCollectionOpenByStartIdempotencyKeyParams) (CashCollection, error) {
	row := q.db.QueryRow(ctx, FindCashCollectionOpenByStartIdempotencyKey, arg.Column1, arg.MachineID)
	var i CashCollection
	err := row.Scan(
		&i.ID,
		&i.MachineID,
...
func (q *Queries) GetCashCollectionByIDForOrgMachine(ctx context.Context, arg GetCashCollectionByIDForOrgMachineParams) (CashCollection, error) {
	row := q.db.QueryRow(ctx, GetCashCollectionByIDForOrgMachine, arg.ID, arg.MachineID)
	var i CashCollection
	err := row.Scan(
		&i.ID,
		&i.MachineID,
...
func (q *Queries) GetOpenCashCollectionByMachine(ctx context.Context, machineID uuid.UUID) (CashCollection, error) {
	row := q.db.QueryRow(ctx, GetOpenCashCollectionByMachine, machineID)
	var i CashCollection
	err := row.Scan(
		&i.ID,
		&i.MachineID,
...
func (q *Queries) ListCashCollectionsForMachine(ctx context.Context, arg ListCashCollectionsForMachineParams) ([]CashCollection, error) {
	rows, err := q.db.Query(ctx, ListCashCollectionsForMachine, arg.MachineID, arg.Limit, arg.Offset)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
