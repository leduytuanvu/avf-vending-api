...
| GET | `/v1/admin/artifacts` | P2 | safe-read | **blocked-missing-seed** |  | blocked-missing-seed: templated path requires seeded resource IDs |
| POST | `/v1/admin/artifacts` | P2 | local-write | **blocked-missing-seed** |  | blocked-missing-seed: templated path requires seeded resource IDs |
| DELETE | `/v1/admin/artifacts/{artifactId}` | P0 | destructive | **blocked-missing-seed** |  | blocked-missing-seed: templated path requires seeded resource IDs |
| GET | `/v1/admin/artifacts/{artifactId}` | P2 | safe-read | **blocked-missing-seed** |  | blocked-missing-seed: templated path requires seeded resource IDs |
| PUT | `/v1/admin/artifacts/{artifactId}/content` | P2 | local-write | **blocked-missing-seed** |  | blocked-missing-seed: templated path requires seeded resource IDs |
| GET | `/v1/admin/artifacts/{artifactId}/download` | P2 | safe-read | **blocked-missing-seed** |  | blocked-missing-seed: templated path requires seeded resource IDs |
| GET | `/v1/admin/companies/{scopeId}/activation-codes` | P2 | safe-read | **blocked-missing-seed** |  | blocked-missing-seed: templated path requires seeded resource IDs |
| POST | `/v1/admin/companies/{scopeId}/activation-codes` | P2 | local-write | **blocked-missing-seed** |  | blocked-missing-seed: templated path requires seeded resource IDs |
| POST | `/v1/admin/companies/{scopeId}/activation-codes/{codeId}/revoke` | P2 | local-write | **blocked-missing-seed** |  | blocked-missing-seed: templated path requires seeded resource IDs |
| GET | `/v1/admin/companies/{scopeId}/anomalies` | P2 | safe-read | **blocked-missing-seed** |  | blocked-missing-seed: templated path requires seeded resource IDs |
| GET | `/v1/admin/companies/{scopeId}/anomalies/{anomalyId}` | P2 | safe-read | **blocked-missing-seed** |  | blocked-missing-seed: templated path requires seeded resource IDs |
| POST | `/v1/admin/companies/{scopeId}/anomalies/{anomalyId}/ignore` | P2 | local-write | **blocked-missing-seed** |  | blocked-missing-seed: templated path requires seeded resource IDs |
| POST | `/v1/admin/companies/{scopeId}/anomalies/{anomalyId}/resolve` | P2 | local-write | **blocked-missing-seed** |  | blocked-missing-seed: templated path requires seeded resource IDs |
| GET | `/v1/admin/companies/{scopeId}/assignments` | P2 | safe-read | **blocked-missing-seed** |  | blocked-missing-seed: templated path requires seeded resource IDs |
| POST | `/v1/admin/companies/{scopeId}/assignments` | P2 | local-write | **blocked-missing-seed** |  | blocked-missing-seed: templated path requires seeded resource IDs |
| DELETE | `/v1/admin/companies/{scopeId}/assignments/{assignmentId}` | P0 | destructive | **blocked-missing-seed** |  | blocked-missing-seed: templated path requires seeded resource IDs |
| GET | `/v1/admin/companies/{scopeId}/assignments/{assignmentId}` | P2 | safe-read | **blocked-missing-seed** |  | blocked-missing-seed: templated path requires seeded resource IDs |
| GET | `/v1/admin/companies/{scopeId}/audit-events` | P2 | safe-read | **blocked-missing-seed** |  | blocked-missing-seed: templated path requires seeded resource IDs |
| GET | `/v1/admin/companies/{scopeId}/audit-events/{auditEventId}` | P2 | safe-read | **blocked-missing-seed** |  | blocked-missing-seed: templated path requires seeded resource IDs |
| GET | `/v1/admin/companies/{scopeId}/commands` | P2 | safe-read | **blocked-missing-seed** |  | blocked-missing-seed: templated path requires seeded resource IDs |
| GET | `/v1/admin/companies/{scopeId}/commands/{commandId}` | P2 | safe-read | **blocked-missing-seed** |  | blocked-missing-seed: templated path requires seeded resource IDs |
| POST | `/v1/admin/companies/{scopeId}/commands/{commandId}/cancel` | P2 | local-write | **blocked-missing-seed** |  | blocked-missing-seed: templated path requires seeded resource IDs |
| POST | `/v1/admin/companies/{scopeId}/commands/{commandId}/retry` | P2 | local-write | **blocked-missing-seed** |  | blocked-missing-seed: templated path requires seeded resource IDs |
| GET | `/v1/admin/companies/{scopeId}/commerce/reconciliation` | P1 | safe-read | **blocked-missing-seed** |  | blocked-missing-seed: templated path requires seeded resource IDs |
| GET | `/v1/admin/companies/{scopeId}/commerce/reconciliation/{id}` | P1 | safe-read | **blocked-missing-seed** |  | blocked-missing-seed: templated path requires seeded resource IDs |
| POST | `/v1/admin/companies/{scopeId}/commerce/reconciliation/{id}/ignore` | P0 | local-write | **blocked-missing-seed** |  | blocked-missing-seed: templated path requires seeded resource IDs |
| POST | `/v1/admin/companies/{scopeId}/commerce/reconciliation/{id}/resolve` | P0 | local-write | **blocked-missing-seed** |  | blocked-missing-seed: templated path requires seeded resource IDs |
| GET | `/v1/admin/companies/{scopeId}/inventory/anomalies` | P1 | safe-read | **blocked-missing-seed** |  | blocked-missing-seed: templated path requires seeded resource IDs |
| POST | `/v1/admin/companies/{scopeId}/inventory/anomalies/{anomalyId}/resolve` | P0 | local-write | **blocked-missing-seed** |  | blocked-missing-seed: templated path requires seeded resource IDs |
| GET | `/v1/admin/companies/{scopeId}/machines` | P1 | safe-read | **blocked-missing-seed** |  | blocked-missing-seed: templated path requires seeded resource IDs |
| POST | `/v1/admin/companies/{scopeId}/machines` | P0 | local-write | **blocked-missing-seed** |  | blocked-missing-seed: templated path requires seeded resource IDs |
| GET | `/v1/admin/companies/{scopeId}/machines/{machineId}` | P1 | safe-read | **blocked-missing-seed** |  | blocked-missing-seed: templated path requires seeded resource IDs |
| PATCH | `/v1/admin/companies/{scopeId}/machines/{machineId}` | P0 | local-write | **blocked-missing-seed** |  | blocked-missing-seed: templated path requires seeded resource IDs |
| POST | `/v1/admin/companies/{scopeId}/machines/{machineId}/archive` | P0 | local-write | **blocked-missing-seed** |  | blocked-missing-seed: templated path requires seeded resource IDs |
| POST | `/v1/admin/companies/{scopeId}/machines/{machineId}/commands` | P0 | local-write | **blocked-missing-seed** |  | blocked-missing-seed: templated path requires seeded resource IDs |
| GET | `/v1/admin/companies/{scopeId}/machines/{machineId}/health` | P1 | safe-read | **blocked-missing-seed** |  | blocked-missing-seed: templated path requires seeded resource IDs |
| GET | `/v1/admin/companies/{scopeId}/machines/{machineId}/inventory/anomalies` | P1 | safe-read | **blocked-missing-seed** |  | blocked-missing-seed: templated path requires seeded resource IDs |
| POST | `/v1/admin/companies/{scopeId}/machines/{machineId}/inventory/reconcile` | P0 | local-write | **blocked-missing-seed** |  | blocked-missing-seed: templated path requires seeded resource IDs |
| POST | `/v1/admin/companies/{scopeId}/machines/{machineId}/mark-compromised` | P0 | local-write | **blocked-missing-seed** |  | blocked-missing-seed: templated path requires seeded resource IDs |
| POST | `/v1/admin/companies/{scopeId}/machines/{machineId}/resume` | P0 | local-write | **blocked-missing-seed** |  | blocked-missing-seed: templated path requires seeded resource IDs |
| POST | `/v1/admin/companies/{scopeId}/machines/{machineId}/revoke-credentials` | P0 | local-write | **blocked-missing-seed** |  | blocked-missing-seed: templated path requires seeded resource IDs |
| POST | `/v1/admin/companies/{scopeId}/machines/{machineId}/revoke-token` | P0 | local-write | **blocked-missing-seed** |  | blocked-missing-seed: templated path requires seeded resource IDs |
| POST | `/v1/admin/companies/{scopeId}/machines/{machineId}/rotate-credentials` | P0 | local-write | **blocked-missing-seed** |  | blocked-missing-seed: templated path requires seeded resource IDs |
| POST | `/v1/admin/companies/{scopeId}/machines/{machineId}/rotate-token-version` | P0 | local-write | **blocked-missing-seed** |  | blocked-missing-seed: templated path requires seeded resource IDs |
| POST | `/v1/admin/companies/{scopeId}/machines/{machineId}/suspend` | P0 | local-write | **blocked-missing-seed** |  | blocked-missing-seed: templated path requires seeded resource IDs |
| GET | `/v1/admin/companies/{scopeId}/machines/{machineId}/technicians` | P1 | safe-read | **blocked-missing-seed** |  | blocked-missing-seed: templated path requires seeded resource IDs |
| POST | `/v1/admin/companies/{scopeId}/machines/{machineId}/technicians` | P0 | local-write | **blocked-missing-seed** |  | blocked-missing-seed: templated path requires seeded resource IDs |
| DELETE | `/v1/admin/companies/{scopeId}/machines/{machineId}/technicians/{userId}` | P0 | destructive | **blocked-missing-seed** |  | blocked-missing-seed: templated path requires seeded resource IDs |
| GET | `/v1/admin/companies/{scopeId}/machines/{machineId}/timeline` | P1 | safe-read | **blocked-missing-seed** |  | blocked-missing-seed: templated path requires seeded resource IDs |
| POST | `/v1/admin/companies/{scopeId}/machines/{machineId}/transfer-site` | P0 | local-write | **blocked-missing-seed** |  | blocked-missing-seed: templated path requires seeded resource IDs |
| GET | `/v1/admin/companies/{scopeId}/media/assets` | P2 | safe-read | **blocked-missing-seed** |  | blocked-missing-seed: templated path requires seeded resource IDs |
| DELETE | `/v1/admin/companies/{scopeId}/media/assets/{assetId}` | P0 | destructive | **blocked-missing-seed** |  | blocked-missing-seed: templated path requires seeded resource IDs |
| GET | `/v1/admin/companies/{scopeId}/media/assets/{assetId}` | P2 | safe-read | **blocked-missing-seed** |  | blocked-missing-seed: templated path requires seeded resource IDs |
| POST | `/v1/admin/companies/{scopeId}/media/product-images` | P2 | local-write | **blocked-missing-seed** |  | blocked-missing-seed: templated path requires seeded resource IDs |
| POST | `/v1/admin/companies/{scopeId}/media/uploads/complete` | P2 | local-write | **blocked-missing-seed** |  | blocked-missing-seed: templated path requires seeded resource IDs |
| POST | `/v1/admin/companies/{scopeId}/media/uploads/init` | P2 | local-write | **blocked-missing-seed** |  | blocked-missing-seed: templated path requires seeded resource IDs |
| GET | `/v1/admin/companies/{scopeId}/operations/machines/health` | P1 | safe-read | **blocked-missing-seed** |  | blocked-missing-seed: templated path requires seeded resource IDs |
| POST | `/v1/admin/companies/{scopeId}/orders/{orderId}/refunds` | P0 | destructive | **blocked-missing-seed** |  | blocked-missing-seed: templated path requires seeded resource IDs |
| GET | `/v1/admin/companies/{scopeId}/orders/{orderId}/timeline` | P1 | safe-read | **blocked-missing-seed** |  | blocked-missing-seed: templated path requires seeded resource IDs |
| GET | `/v1/admin/companies/{scopeId}/products/{productId}/images` | P2 | safe-read | **blocked-missing-seed** |  | blocked-missing-seed: templated path requires seeded resource IDs |
| POST | `/v1/admin/companies/{scopeId}/products/{productId}/images` | P2 | local-write | **blocked-missing-seed** |  | blocked-missing-seed: templated path requires seeded resource IDs |
| DELETE | `/v1/admin/companies/{scopeId}/products/{productId}/images/{imageId}` | P0 | destructive | **blocked-missing-seed** |  | blocked-missing-seed: templated path requires seeded resource IDs |
| PATCH | `/v1/admin/companies/{scopeId}/products/{productId}/images/{imageId}` | P2 | local-write | **blocked-missing-seed** |  | blocked-missing-seed: templated path requires seeded resource IDs |
| POST | `/v1/admin/companies/{scopeId}/products/{productId}/media` | P2 | local-write | **blocked-missing-seed** |  | blocked-missing-seed: templated path requires seeded resource IDs |
| DELETE | `/v1/admin/companies/{scopeId}/products/{productId}/media/{mediaId}` | P0 | destructive | **blocked-missing-seed** |  | blocked-missing-seed: templated path requires seeded resource IDs |
| GET | `/v1/admin/companies/{scopeId}/provisioning/batches/{batchId}` | P2 | safe-read | **blocked-missing-seed** |  | blocked-missing-seed: templated path requires seeded resource IDs |
| POST | `/v1/admin/companies/{scopeId}/provisioning/machines/bulk` | P0 | local-write | **blocked-missing-seed** |  | blocked-missing-seed: templated path requires seeded resource IDs |
| GET | `/v1/admin/companies/{scopeId}/refunds` | P2 | safe-read | **blocked-missing-seed** |  | blocked-missing-seed: templated path requires seeded resource IDs |
| GET | `/v1/admin/companies/{scopeId}/refunds/{refundId}` | P2 | safe-read | **blocked-missing-seed** |  | blocked-missing-seed: templated path requires seeded resource IDs |
| GET | `/v1/admin/companies/{scopeId}/reports/cash` | P2 | safe-read | **blocked-missing-seed** |  | blocked-missing-seed: templated path requires seeded resource IDs |
| GET | `/v1/admin/companies/{scopeId}/reports/commands` | P2 | safe-read | **blocked-missing-seed** |  | blocked-missing-seed: templated path requires seeded resource IDs |
| GET | `/v1/admin/companies/{scopeId}/reports/export` | P2 | safe-read | **blocked-missing-seed** |  | blocked-missing-seed: templated path requires seeded resource IDs |
| GET | `/v1/admin/companies/{scopeId}/reports/failed-vends` | P0 | hardware-required | **blocked-missing-seed** |  | blocked-missing-seed: templated path requires seeded resource IDs |
| GET | `/v1/admin/companies/{scopeId}/reports/fills` | P2 | safe-read | **blocked-missing-seed** |  | blocked-missing-seed: templated path requires seeded resource IDs |
| GET | `/v1/admin/companies/{scopeId}/reports/inventory` | P1 | safe-read | **blocked-missing-seed** |  | blocked-missing-seed: templated path requires seeded resource IDs |
| GET | `/v1/admin/companies/{scopeId}/reports/inventory-low-stock` | P1 | safe-read | **blocked-missing-seed** |  | blocked-missing-seed: templated path requires seeded resource IDs |
| GET | `/v1/admin/companies/{scopeId}/reports/machine-health` | P1 | safe-read | **blocked-missing-seed** |  | blocked-missing-seed: templated path requires seeded resource IDs |
| GET | `/v1/admin/companies/{scopeId}/reports/machines` | P1 | safe-read | **blocked-missing-seed** |  | blocked-missing-seed: templated path requires seeded resource IDs |
| GET | `/v1/admin/companies/{scopeId}/reports/payments` | P0 | provider-required | **blocked-missing-seed** |  | blocked-missing-seed: templated path requires seeded resource IDs |
| GET | `/v1/admin/companies/{scopeId}/reports/products` | P2 | safe-read | **blocked-missing-seed** |  | blocked-missing-seed: templated path requires seeded resource IDs |
| GET | `/v1/admin/companies/{scopeId}/reports/reconciliation` | P2 | safe-read | **blocked-missing-seed** |  | blocked-missing-seed: templated path requires seeded resource IDs |
| GET | `/v1/admin/companies/{scopeId}/reports/reconciliation-queue` | P2 | safe-read | **blocked-missing-seed** |  | blocked-missing-seed: templated path requires seeded resource IDs |
| GET | `/v1/admin/companies/{scopeId}/reports/refunds` | P2 | safe-read | **blocked-missing-seed** |  | blocked-missing-seed: templated path requires seeded resource IDs |
| GET | `/v1/admin/companies/{scopeId}/reports/sales` | P2 | safe-read | **blocked-missing-seed** |  | blocked-missing-seed: templated path requires seeded resource IDs |
| GET | `/v1/admin/companies/{scopeId}/reports/vends` | P0 | hardware-required | **blocked-missing-seed** |  | blocked-missing-seed: templated path requires seeded resource IDs |
| GET | `/v1/admin/companies/{scopeId}/restock/suggestions` | P2 | safe-read | **blocked-missing-seed** |  | blocked-missing-seed: templated path requires seeded resource IDs |
| GET | `/v1/admin/companies/{scopeId}/rollouts` | P2 | safe-read | **blocked-missing-seed** |  | blocked-missing-seed: templated path requires seeded resource IDs |
| POST | `/v1/admin/companies/{scopeId}/rollouts` | P2 | local-write | **blocked-missing-seed** |  | blocked-missing-seed: templated path requires seeded resource IDs |
| GET | `/v1/admin/companies/{scopeId}/rollouts/{rolloutId}` | P2 | safe-read | **blocked-missing-seed** |  | blocked-missing-seed: templated path requires seeded resource IDs |
| POST | `/v1/admin/companies/{scopeId}/rollouts/{rolloutId}/cancel` | P2 | local-write | **blocked-missing-seed** |  | blocked-missing-seed: templated path requires seeded resource IDs |
| POST | `/v1/admin/companies/{scopeId}/rollouts/{rolloutId}/pause` | P2 | local-write | **blocked-missing-seed** |  | blocked-missing-seed: templated path requires seeded resource IDs |
| POST | `/v1/admin/companies/{scopeId}/rollouts/{rolloutId}/resume` | P2 | local-write | **blocked-missing-seed** |  | blocked-missing-seed: templated path requires seeded resource IDs |
| POST | `/v1/admin/companies/{scopeId}/rollouts/{rolloutId}/rollback` | P2 | local-write | **blocked-missing-seed** |  | blocked-missing-seed: templated path requires seeded resource IDs |
| POST | `/v1/admin/companies/{scopeId}/rollouts/{rolloutId}/start` | P2 | local-write | **blocked-missing-seed** |  | blocked-missing-seed: templated path requires seeded resource IDs |
| GET | `/v1/admin/companies/{scopeId}/sites` | P2 | safe-read | **blocked-missing-seed** |  | blocked-missing-seed: templated path requires seeded resource IDs |
| POST | `/v1/admin/companies/{scopeId}/sites` | P2 | local-write | **blocked-missing-seed** |  | blocked-missing-seed: templated path requires seeded resource IDs |
| DELETE | `/v1/admin/companies/{scopeId}/sites/{siteId}` | P0 | destructive | **blocked-missing-seed** |  | blocked-missing-seed: templated path requires seeded resource IDs |
| GET | `/v1/admin/companies/{scopeId}/sites/{siteId}` | P2 | safe-read | **blocked-missing-seed** |  | blocked-missing-seed: templated path requires seeded resource IDs |
| PATCH | `/v1/admin/companies/{scopeId}/sites/{siteId}` | P2 | local-write | **blocked-missing-seed** |  | blocked-missing-seed: templated path requires seeded resource IDs |
| POST | `/v1/admin/companies/{scopeId}/sites/{siteId}/archive` | P2 | local-write | **blocked-missing-seed** |  | blocked-missing-seed: templated path requires seeded resource IDs |
| GET | `/v1/admin/companies/{scopeId}/technicians` | P2 | safe-read | **blocked-missing-seed** |  | blocked-missing-seed: templated path requires seeded resource IDs |
| POST | `/v1/admin/companies/{scopeId}/technicians` | P2 | local-write | **blocked-missing-seed** |  | blocked-missing-seed: templated path requires seeded resource IDs |
| GET | `/v1/admin/companies/{scopeId}/technicians/{technicianId}` | P2 | safe-read | **blocked-missing-seed** |  | blocked-missing-seed: templated path requires seeded resource IDs |
| PATCH | `/v1/admin/companies/{scopeId}/technicians/{technicianId}` | P2 | local-write | **blocked-missing-seed** |  | blocked-missing-seed: templated path requires seeded resource IDs |
| POST | `/v1/admin/companies/{scopeId}/technicians/{technicianId}/disable` | P2 | local-write | **blocked-missing-seed** |  | blocked-missing-seed: templated path requires seeded resource IDs |
| POST | `/v1/admin/companies/{scopeId}/technicians/{technicianId}/enable` | P2 | local-write | **blocked-missing-seed** |  | blocked-missing-seed: templated path requires seeded resource IDs |
| GET | `/v1/admin/companies/{scopeId}/users` | P2 | safe-read | **blocked-missing-seed** |  | blocked-missing-seed: templated path requires seeded resource IDs |
| POST | `/v1/admin/companies/{scopeId}/users` | P2 | local-write | **blocked-missing-seed** |  | blocked-missing-seed: templated path requires seeded resource IDs |
| GET | `/v1/admin/companies/{scopeId}/users/{userId}` | P2 | safe-read | **blocked-missing-seed** |  | blocked-missing-seed: templated path requires seeded resource IDs |
| PATCH | `/v1/admin/companies/{scopeId}/users/{userId}` | P2 | local-write | **blocked-missing-seed** |  | blocked-missing-seed: templated path requires seeded resource IDs |
| POST | `/v1/admin/companies/{scopeId}/users/{userId}/disable` | P2 | local-write | **blocked-missing-seed** |  | blocked-missing-seed: templated path requires seeded resource IDs |
| POST | `/v1/admin/companies/{scopeId}/users/{userId}/enable` | P2 | local-write | **blocked-missing-seed** |  | blocked-missing-seed: templated path requires seeded resource IDs |
| POST | `/v1/admin/companies/{scopeId}/users/{userId}/reset-password` | P2 | local-write | **blocked-missing-seed** |  | blocked-missing-seed: templated path requires seeded resource IDs |
| POST | `/v1/admin/companies/{scopeId}/users/{userId}/revoke-sessions` | P2 | local-write | **blocked-missing-seed** |  | blocked-missing-seed: templated path requires seeded resource IDs |
| PATCH | `/v1/admin/companies/{scopeId}/users/{userId}/roles` | P2 | local-write | **blocked-missing-seed** |  | blocked-missing-seed: templated path requires seeded resource IDs |
| POST | `/v1/admin/companies/{scopeId}/users/{userId}/roles` | P2 | local-write | **blocked-missing-seed** |  | blocked-missing-seed: templated path requires seeded resource IDs |
| DELETE | `/v1/admin/companies/{scopeId}/users/{userId}/roles/{role}` | P0 | destructive | **blocked-missing-seed** |  | blocked-missing-seed: templated path requires seeded resource IDs |
| GET | `/v1/admin/companies/{scopeId}/users/{userId}/sessions` | P2 | safe-read | **blocked-missing-seed** |  | blocked-missing-seed: templated path requires seeded resource IDs |
| PATCH | `/v1/admin/companies/{scopeId}/users/{userId}/status` | P2 | local-write | **blocked-missing-seed** |  | blocked-missing-seed: templated path requires seeded resource IDs |
