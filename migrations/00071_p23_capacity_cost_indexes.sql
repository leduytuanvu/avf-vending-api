...
CREATE INDEX IF NOT EXISTS ix_audit_logs_company_created_action ON audit_logs (scope_id, created_at DESC, action);
...
COMMENT ON INDEX ix_audit_logs_company_created_action IS 'P2.3: company audit_logs timelines (legacy table).';
...
DROP INDEX IF EXISTS ix_audit_logs_company_created_action;
