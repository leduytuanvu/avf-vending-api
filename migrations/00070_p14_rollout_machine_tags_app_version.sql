...
CREATE INDEX ix_machine_tag_assignments_org_tag ON machine_tag_assignments (scope_id, tag_id);

CREATE INDEX ix_machine_tag_assignments_org_machine ON machine_tag_assignments (scope_id, machine_id);

COMMENT ON TABLE machine_tag_assignments IS 'Role-scoped machine labels (catalog tags) for fleet targeting (rollouts, filters).';
