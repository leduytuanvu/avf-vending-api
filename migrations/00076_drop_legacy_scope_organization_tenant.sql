...
-- =============================================================================
-- 00076 final cleanup: single-company deployment model only.
--
-- Removes tenant / organization / company-scope columns (scope_id, …), renames
-- remaining columns whose NAMES contained legacy tokens (assignment_domain,
-- price_book_level, promotion_channel_kind, mqtt_broker_shard, …), drops
-- dependent constraints/indexes, and recreates views that previously projected
-- scope_id.
--
-- IRREVERSIBLE without restore-from-backup — operators must verify on a clone.
-- =============================================================================
...
DO $$
BEGIN
    RAISE EXCEPTION '00076_drop_legacy_scope_organization_tenant is intentionally irreversible; restore from backup';
END $$;
