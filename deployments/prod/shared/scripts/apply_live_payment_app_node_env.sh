...
COMMERCE_WINNER_ARBITRATION_ENABLED="${COMMERCE_WINNER_ARBITRATION_ENABLED:-true}"
set_env_kv "COMMERCE_WINNER_ARBITRATION_ENABLED" "${COMMERCE_WINNER_ARBITRATION_ENABLED}"

echo "apply_live_payment_app_node_env: ok (PAYMENT_ENV=${PAYMENT_ENV}, PROVIDER=${COMMERCE_PAYMENT_PROVIDER}, PROVIDERS=${COMMERCE_PAYMENT_PROVIDERS}, WINNER_ARBITRATION=${COMMERCE_WINNER_ARBITRATION_ENABLED})"
