#!/usr/bin/env bash
# Emits native Postman collection + environment files under postman/collections/ and postman/environments/.
...
echo "OK: Postman artifacts under postman/collections/ and postman/environments/"
