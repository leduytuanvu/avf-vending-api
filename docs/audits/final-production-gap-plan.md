...
| P1 | **Two-VPS / split topology** operational maturity | `docs/deployment/two-vps-rolling-production-deploy.md`; `deployments/prod/shared/README.md` | Wrong failover | Game days | Checklist signoff |
...
- [x] **`docs/audits/final-production-gap-plan.md`** updated (this file).
