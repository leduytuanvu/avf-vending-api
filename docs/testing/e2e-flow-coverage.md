...
**Automation status:** Web Admin scaffolding for **WA-002–WA-009** is partially covered by **`tests/e2e/run-web-admin-flows.sh`** (flow **WA-SETUP-01**, `scenarios/01_web_admin_setup.sh`). Remaining rows are **`planned`** or manual until expanded.
