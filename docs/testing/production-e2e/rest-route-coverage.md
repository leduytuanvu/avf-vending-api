...
- **Generated:** `2026-05-24T18:40:07Z`
- **Swagger source:** `.tmp-swagger-prod.json`
- **Total routes:** 330
- **Coverage buckets:** `{'readonly_smoke': 73, 'documented_skip': 72, 'auth_negative': 146, 'success': 37, 'permission_negative': 2}`
...
| POST | `/v1/admin/activation-codes` | auth_negative | REST-COV-POS-0110 | False |  |
| POST | `/v1/admin/activation-codes/{codeId}/revoke` | auth_negative | REST-COV-POS-0111 | False |  |
...
| POST | `/v1/admin/anomalies/{anomalyId}/ignore` | auth_negative | REST-COV-POS-0112 | False |  |
| POST | `/v1/admin/anomalies/{anomalyId}/resolve` | auth_negative | REST-COV-POS-0113 | False |  |
| GET | `/v1/admin/artifacts` | readonly_smoke | REST-COV-GET-0023 | False |  |
| POST | `/v1/admin/artifacts` | auth_negative | REST-COV-POS-0114 | False |  |
...
| PUT | `/v1/admin/artifacts/{artifactId}/content` | auth_negative | REST-COV-PUT-0205 | False |  |
...
| POST | `/v1/admin/assignments` | auth_negative | REST-COV-POS-0115 | False |  |
...
| POST | `/v1/admin/auth/users` | auth_negative | REST-COV-POS-0116 | False |  |
| GET | `/v1/admin/auth/users/{accountId}` | documented_skip | — | False | No auto rule matched |
| PATCH | `/v1/admin/auth/users/{accountId}` | auth_negative | REST-COV-PAT-0092 | False |  |
| POST | `/v1/admin/auth/users/{accountId}/activate` | auth_negative | REST-COV-POS-0117 | False |  |
| POST | `/v1/admin/auth/users/{accountId}/deactivate` | auth_negative | REST-COV-POS-0118 | False |  |
| POST | `/v1/admin/auth/users/{accountId}/reset-password` | auth_negative | REST-COV-POS-0119 | False |  |
| POST | `/v1/admin/auth/users/{accountId}/revoke-sessions` | auth_negative | REST-COV-POS-0120 | False |  |
| PATCH | `/v1/admin/auth/users/{accountId}/roles` | auth_negative | REST-COV-PAT-0093 | False |  |
| POST | `/v1/admin/auth/users/{accountId}/roles` | auth_negative | REST-COV-POS-0121 | False |  |
| PUT | `/v1/admin/auth/users/{accountId}/roles` | auth_negative | REST-COV-PUT-0206 | False |  |
| GET | `/v1/admin/auth/users/{accountId}/sessions` | documented_skip | — | False | No auto rule matched |
| PATCH | `/v1/admin/auth/users/{accountId}/status` | auth_negative | REST-COV-PAT-0094 | False |  |
...
| PATCH | `/v1/admin/brands/{brandId}` | auth_negative | REST-COV-PAT-0095 | False |  |
| PUT | `/v1/admin/brands/{brandId}` | auth_negative | REST-COV-PUT-0207 | False |  |
...
| PATCH | `/v1/admin/categories/{categoryId}` | auth_negative | REST-COV-PAT-0096 | False |  |
| PUT | `/v1/admin/categories/{categoryId}` | auth_negative | REST-COV-PUT-0208 | False |  |
...
| POST | `/v1/admin/commands/{commandId}/cancel` | auth_negative | REST-COV-POS-0122 | False |  |
| POST | `/v1/admin/commands/{commandId}/retry` | auth_negative | REST-COV-POS-0123 | False |  |
...
| POST | `/v1/admin/commerce/reconciliation/{caseId}/ignore` | auth_negative | REST-COV-POS-0124 | False |  |
| POST | `/v1/admin/commerce/reconciliation/{caseId}/request-refund` | auth_negative | REST-COV-POS-0125 | False |  |
| POST | `/v1/admin/commerce/reconciliation/{caseId}/resolve` | auth_negative | REST-COV-POS-0126 | False |  |
| GET | `/v1/admin/feature-flags` | readonly_smoke | REST-COV-GET-0029 | False |  |
| POST | `/v1/admin/feature-flags` | auth_negative | REST-COV-POS-0127 | False |  |
| GET | `/v1/admin/feature-flags/{flagId}` | documented_skip | — | False | No auto rule matched |
| PATCH | `/v1/admin/feature-flags/{flagId}` | auth_negative | REST-COV-PAT-0097 | False |  |
| … | *269 more* | | | | |
