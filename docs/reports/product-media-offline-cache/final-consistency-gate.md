...
**Report:** `docs/reports/product-media-offline-cache/final-consistency-gate.md`  
...
| Full Postman suite | `python postman/suites/full-production-suite/generate_full_postman_suite.py` | **PASS** — `VALIDATION_PASS`, `PASS_IMPORT_ASSETS_COMPLETE` |
| Postman asset validator | `python postman/suites/full-production-suite/validate_generated_assets.py` | **PASS** — `VALIDATION_PASS` |
...
| Postman collection | `postman/collections/avf-vending-api.postman_collection.json` | **OK** |
| Postman environment | `postman/environments/avf-local.postman_environment.json` | **OK** |
| gRPC request templates | `postman/suites/full-production-suite/grpc/grpc_request_templates.json` | **OK** |
| MQTT request templates | `postman/suites/full-production-suite/mqtt/mqtt_request_templates.json` | **OK** |
| MQTT payloads bundle | `postman/suites/full-production-suite/mqtt/AVF_MQTT_100_PAYLOADS.json` | **OK** |
...
| **MQTT binary/base64 images** | Ripgrep under `postman/suites/full-production-suite/mqtt/` | **No hits** for `base64`, `imageBase64`, `data:image` |
...
- `docs/postman/*.json`
- Full-suite outputs under `postman/suites/full-production-suite/` (via generator script)
...
- `postman/collections/avf-vending-api.postman_collection.json`, `postman/collections/avf-vending-api-function-path.postman_collection.json`, `docs/postman/avf-*.postman_environment.json` — regenerated
- `postman/suites/full-production-suite/**` — refreshed by `generate_full_postman_suite.py` / validator (as produced by the scripts)
