...
**Report path:** `docs/reports/product-media-offline-cache/final-regression-report.md`  
...
| FULL suite validator | `python postman/suites/full-production-suite/validate_generated_assets.py` | **PASS** (`VALIDATION_PASS`, REST 327 / gRPC 86 / MQTT 28) |
...
| Postman collection | `postman/collections/avf-vending-api.postman_collection.json` |
| Postman env (example) | `postman/environments/avf-local.postman_environment.json` |
| FULL parity collection | `postman/suites/full-production-suite/AVF_REST_365_FULL.postman_collection.json` |
| FULL env | `postman/suites/full-production-suite/AVF_FULL_100.postman_environment.json` |
| Manifest | `postman/suites/full-production-suite/manifest.json` |
...
**Proto / docs:** `proto/avf/machine/v1/catalog.proto`, `docs/api/machine-grpc.md` updated as part of the branch; FULL suite gRPC matrix: `postman/suites/full-production-suite/grpc/AVF_GRPC_86_METHOD_MATRIX.csv`.
...
**Contract / suite:** `docs/api/mqtt-contract.md`; FULL suite MQTT assets under `postman/suites/full-production-suite/mqtt/`.
...
| Category | Location |
|----------|----------|
| Regression report | `docs/reports/product-media-offline-cache/final-regression-report.md` |
| Migrations | `migrations/*.sql` |
| Swagger | `docs/swagger/swagger.json`, `docs/swagger/docs.go` |
| Postman (docs) | `docs/postman/*.json` |
| FULL Postman suite | `postman/suites/full-production-suite/*` |
