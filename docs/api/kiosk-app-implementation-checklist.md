...
| --- | --- | --- | --- |
| 1.1 | **Machine binding** | Persist `machineId` (UUID), optional `companyId`, site hints from bootstrap/claims. Never hardcode in customer build. | `GET /v1/setup/machines/{machineId}/bootstrap`; activation/claim (**confirm** OpenAPI) |
