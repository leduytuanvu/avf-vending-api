...
def missing_reference_component_schemas() -> dict[str, Any]:
    ...
    return {
        ...
        "V1AdminProductImageUploadResponse": {
            "type": "object",
            "properties": {
                "mediaId": dict(uuid_s),
                "provider": {"type": "string", "example": "cloudinary"},
                "sourceType": {"type": "string", "example": "uploaded_file"},
                "status": {"type": "string", "example": "ready"},
                "filename": {"type": "string"},
                "contentType": {"type": "string"},
            ...
            "required": ["mediaId", "provider", "sourceType", "status", "contentType", "sizeBytes", "checksum", "displayUrl", "thumbnailUrl", "version", "createdAt"],
        },
                ...
                "200": (
                    {
                        ...
                        "refreshTokenExpiresAt": "2026-05-24T00:00:00Z",
                        "mqttUsername": _U3,
                        "mqttPassword": "<secret>",
                        "deviceAttachmentId": "22222222-3333-4444-5555-666666666666",
