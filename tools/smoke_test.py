...
def main_local_e2e(argv: list[str] | None = None) -> int:
    ...
    try:
        ...
        # Auth
        login_body = {"email": args.admin_email, "password": args.admin_password}
        ...
        cat = _http_expect_ok(
            ...
            "POST",
            urljoin(base + "/", "v1/admin/categories"),
        ...
        pr = _http_expect_ok(
            ...
            "POST",
            urljoin(base + "/", "v1/admin/products"),
        ...
        plist = _http_expect_ok(
            ...
            "GET",
            urljoin(base + "/", "v1/admin/products") + "?limit=10&offset=0",
        ...
        act = _http_expect_ok(
            ...
            "POST",
            urljoin(base + "/", f"v1/admin/machines/{machine_id}/activation-codes"),
        ...
        try:
            ...
            slots_out = _http_expect_ok(
                "admin slots",
                "GET",
                urljoin(base + "/", f"v1/admin/machines/{machine_id}/slots"),
                headers=auth_headers,
                json_body=None,
                timeout=timeout,
            )
        ...
        rep_q = "?from=" + urllib.parse.quote(frm, safe="") + "&to=" + urllib.parse.quote(to, safe="")
        for path, label in (
